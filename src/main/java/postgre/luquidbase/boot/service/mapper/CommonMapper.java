...
/**<b>Использование данного Mapper не поможет избежать зацикливания, при обработке
 * сущности, имеющий связанные объекты (ассоциации на другие бизнес-объекты
 * в реляционной базе данных)/b>
